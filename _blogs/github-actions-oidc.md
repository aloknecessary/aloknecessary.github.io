...
date: 2026-07-27
last_modified_at: 2026-07-27T12:41:00+05:30
author: Alok Ranjan Daftuar
description: "A production implementation guide to GitHub Actions OIDC authentication for AWS and Azure - trust policy design, sub claim scoping, per-job role architecture, reusable workflow federation, the migration path from static secrets, and the audit trail OIDC gives you that stored credentials never could."
