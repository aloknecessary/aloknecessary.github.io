...
| Working | Request-scoped | Every agentic step | Variable (0–8K) | Highest within agentic loops | [Agentic RAG](https://aloknecessary.github.io/blogs/designing-self-correcting-retrieval-loops-for-production/) → this post |
...
Context assembly quality directly affects the RAGAS metrics established in the [LLM Evaluation in Production](https://aloknecessary.github.io/blogs/llm-evaluation-in-production/) post. The connection is not abstract — each assembly failure mode produces a predictable signature in the metric scores:
